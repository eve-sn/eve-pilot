...
def home(request):
    ...
    context = {
        ...
        "rh_reference_staff_cards": [
            {
                "label": "Salariés et contractuels",
                "value": rh_reference_staff["salaried_and_contractual"],
                "note": "Personnel sous contrat, dont les fiches sont dans l'espace RH.",
                "tone": "soft-green",
            },
            {
                "label": "Prestataires de terrain",
                "value": rh_reference_staff["service_providers"],
                "note": "Supervision, logistique et animation sur le terrain.",
                "tone": "soft-blue",
            },
            {
                "label": "Consultants et experts",
                "value": rh_reference_staff["consultants"],
                "note": "Experts intervenant sur plusieurs projets.",
                "tone": "soft-amber",
            },
            {
                "label": "Acteurs communautaires",
                "value": rh_reference_community["total_actors"],
                "note": "Relais, ICP, postes de santé, accompagnateurs et superviseurs.",
                "tone": "",
            },
        ],
